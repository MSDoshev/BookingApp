    ...
    return(
        ...
        <div className={styles.title}>
            ...
            <div className={styles.infoH}>
                ...
                <img data-aos="fade-left" data-aos-duration="1500" src="https://www.mykonostownhousehotel.com/wp-content/uploads/2017/01/mykonos_towhhouse_hotel_paraportiani2.jpg"/>
            </div>

            <div className={styles.infoN}>
                <img data-aos="fade-right" data-aos-duration="1500" src="https://www.oluxuryvillas.com/img/article/image/mykonos_nightlife_oluxuryvillas.jpg"/>
                <div className={styles.subInfo}>
